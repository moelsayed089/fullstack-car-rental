      ...
      <div className="rounded-md bg-white p-5 mb-12">
        <div className="flex items-center mb-4 bg-white">
          ...
          <div className="ml-auto">
            {userId && <AddReviewForm userId={userId} />}
          </div>
        </div>
        ...
        <div className="space-y-5">
          ...
          {reviews.map((review) => (
            <>
              <div className="flex flex-col space-y-2 bg-gray-100/30  p-4 rounded-md">
                ...
                {review.userId === userId && (
                  <div className="self-end">
                    <DeleteReview reviewId={review.id} userId={userId} />
                  </div>
                )}
              </div>
            </>
